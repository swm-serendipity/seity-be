...
public enum BaseResponseStatus {
    ...
    INVALID_MEMBER_PART_EXCEPTION(false, 2033, HttpStatus.BAD_REQUEST, "part 값이 존재하지 않거나 올바르지 않습니다."),
    INVALID_MEMBER_ROLE_EXCEPTION(false, 2034, HttpStatus.BAD_REQUEST, "role 값이 존재하지 않거나 올바르지 않습니다."),

    FILE_MAX_SIZE_EXCEEDED(false, 2041, HttpStatus.BAD_REQUEST, "파일 업로드 용량을 초과헀습니다."),

    /**
     * 5000 : Database, Server 오류
     */
    DATABASE_ERROR(false, 5000, HttpStatus.INTERNAL_SERVER_ERROR,"데이터베이스 연결에 실패하였습니다."),
    SERVER_ERROR(false, 5001, HttpStatus.INTERNAL_SERVER_ERROR, "서버와의 연결에 실패하였습니다."),
    UNKNOWN_SERVER_EXCEPTION(false,5002, HttpStatus.BAD_REQUEST, "알 수 없는 서버 오류가 발생했습니다.");
